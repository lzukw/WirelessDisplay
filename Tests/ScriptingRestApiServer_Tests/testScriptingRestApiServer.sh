...
curl -v -H "Accept: application/json" -H "Content-Type: application/json" --data '{ "ScriptName" : "testscript_for_run", "ScriptArgs" : "arg1 arg2 arg3 arg4", "StdIn" : "\n" }' http://$IP:$PORT/api/ScriptRunner/RunScript
...
RES=$(curl -v -H "Accept: application/json" -H "Content-Type: application/json" --data '{ "ScriptName" : "testscript_for_start_stop", "ScriptArgs" : "arg1 arg2 arg3 arg4", "StdIn" : "\n" }' http://$IP:$PORT/api/ScriptRunner/StartScript)
echo $RES
...
curl -v -H "Accept: application/json" -H "Content-Type: application/json" --data "{ \"ProcessId\" : $PROCESS_ID }" http://$IP:$PORT/api/ScriptRunner/IsScriptRunning
...
echo ""
curl -v -H "Accept: application/json" -H "Content-Type: application/json" --data "{ \"ProcessId\" : $PROCESS_ID }" http://$IP:$PORT/api/ScriptRunner/StopScript
